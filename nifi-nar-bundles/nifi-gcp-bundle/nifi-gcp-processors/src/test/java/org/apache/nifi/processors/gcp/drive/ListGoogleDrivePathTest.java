...
public class ListGoogleDrivePathTest implements OutputChecker {
    ...
    void testPath() throws Exception {
        ...
        Set<Map<String, String>> expectedAttributes = Collections.unmodifiableSet(new HashSet<>(Arrays.asList(
    ...
    private Map<String, String> createAttributeMap(String fileId, String fileName, String path) {
        ...
        map.put(GoogleDriveAttributes.ID, fileId);
        map.put(GoogleDriveAttributes.FILENAME, fileName);
        map.put(GoogleDriveAttributes.PATH, path);
    ...
    public Set<String> getCheckedAttributeNames() {
        return Collections.unmodifiableSet(new HashSet<>(Arrays.asList(ID, FILENAME, PATH)));
    }
}